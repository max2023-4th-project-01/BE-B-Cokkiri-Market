INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `price`,
                                     `status`, `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '치이카와 시계', 1, '서울특별시 강남구 역삼동', 1000, 0,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `price`,
                                     `status`, `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '깨진 아이폰', 1, '서울특별시 강남구 역삼동', 20000, 2,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `price`,
                                     `status`, `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '자전거 팝니다', 1, '서울특별시 강남구 역삼동', 30000, 1,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `price`,
                                     `status`, `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '댕댕이 산책', 1, '서울특별시 강남구 역삼동', 0, 0,
        'https://cokkiri-s3.s3.ap-northeast-2.amazonaws.com/itemImage/245c318c-5d97-4913-bf36-e7b4588037881527857574711(1).jpg',
        '댕댕이 산책 알바 구합니다', 1, 32);
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `status`,
                                     `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '그림', 1, '서울특별시 강남구 역삼동', 0,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `status`,
                                     `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '먹태깡 ', 1, '서울특별시 강남구 역삼동', 0,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `status`,
                                     `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '기타', 1, '서울특별시 강남구 역삼동', 0,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `status`,
                                     `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '바람막이', 1, '서울특별시 강남구 역삼동', 1,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `status`,
                                     `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '오카리나', 1, '서울특별시 강남구 역삼동', 2,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `price`,
                                     `status`, `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '젤다 갓 겜', 1, '서울특별시 강남구 역삼동', 30000, 2,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `price`,
                                     `status`, `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '동숲', 1, '서울특별시 강남구 역삼동', 62000, 1,
...
INSERT INTO `cokkiri_market`.`item` (`created_at`, `category_id`, `content`, `location_id`, `location_name`, `price`,
                                     `status`, `thumbnail_url`, `title`, `user_id`, `view_count`)
VALUES (NOW(), 1, '에버랜드', 1, '서울특별시 강남구 역삼동', 33000, 1,
...
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('1',
        'https://cokkiri-s3.s3.ap-northeast-2.amazonaws.com/itemImage/%E1%84%8E%E1%85%B5%E1%84%8B%E1%85%B5%E1%84%8F%E1%85%A1%E1%84%8B%E1%85%AA.jpg');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('2',
...
VALUES ('10',
        'https://upload.wikimedia.org/wikipedia/ko/thumb/c/cf/%EB%B8%8C%EB%A0%88%EC%8A%A4_%EC%98%A4%EB%B8%8C_%EB%8D%94_%EC%99%80%EC%9D%BC%EB%93%9C.jpg/230px-%EB%B8%8C%EB%A0%88%EC%8A%A4_%EC%98%A4%EB%B8%8C_%EB%8D%94_%EC%99%80%EC%9D%BC%EB%93%9C.jpg');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('11', 'https://cdn.011st.com/11dims/resize/600x600/quality/75/11src/product/5581146608/B.jpg?871000000');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('12',
        'https://i.namu.wiki/i/dTxWry1hO7uw43fr05d2krIZhQH_-fAoqSpBqkQHdDoV-baWRZKj9hf4b-A0fhynBv7fGT6lr5Fm2y2uFzICuQ.webp');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
...
VALUES ('14',
        'https://mblogthumb-phinf.pstatic.net/MjAxOTA2MjJfOTcg/MDAxNTYxMjE1MDg1MzE3.b9bmlLhCuWObP3CGAi8QRCdCoh7q6gee2DPakFbdjQcg.DI_4hVsA_YmI5ccFn5sxYZBtMUEosmXNoKu1Ot1Adrog.JPEG.142819xx/DSCF9481.JPG?type=w800');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('15', 'https://img.biteme.co.kr/product/750/ffae80f3f9316e065c7afda2fe42ca08.jpg');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('16', 'https://coresos-phinf.pstatic.net/a/30geij/b_935Ud018svc1yx83yuky31_hrcm5e.jpg?type=cover_a640');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('17', 'https://webimage.10x10.co.kr/image/basic600/244/B002446586.jpg');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('18', 'https://m.thesuperplay.com/web/product/big/202211/b4e8dd4e6d8b3f852897cbb10a0f4e89.png');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('19', 'https://image.vans.co.kr/cmsstatic/product/VN0A5JIVCMA1_VN0A5JIVCMA1_primary.jpg?browse');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('20', 'https://i.pinimg.com/736x/11/96/2b/11962bb6654bcca8f47b28ee46d7f08e.jpg');
INSERT INTO `cokkiri_market`.`image` (`item_id`, `url`)
VALUES ('21',
        'https://mblogthumb-phinf.pstatic.net/MjAxNzA0MjVfMjc1/MDAxNDkzMTIzMjMyNjEw.FxzWI1adhcle8nPnyFuDHwv3dEMfhxCA9h4PbJLIcWUg.OpoK9GiEcg6xH2OpmZtrJXrvURkpUa8IPRL5Vn2V8yQg.JPEG.juka_6666/image_5627185291493123112382.jpg?type=w800');
